...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_universal(
    ...
    KC_LCTL  , KC_LALT  , KC_LALT  , KC_LANG2,KC_LGUI,LT(2,KC_SPC),KC_ENT,                        KC_BSPC,KC_LANG1_ENT,_______,_______, _______ , KC_RALT  , KC_BSLS
  ),
  [4] = LAYOUT_universal(
  ...
  [1] = LAYOUT_universal(
    ...
    _______    , KC_Z     , KC_X     , KC_C     , KC_V     , KC_B     , KC_RBRC  ,              KC_SLSH, KC_N     , KC_M     , KC_COMM  , KC_DOT   , KC_SLSH  , _______  ,
    _______  , _______  , _______  , _______,_______,_______,_______,    _______,_______,_______,_______, _______ , _______  , _______
  ),
  [2] = LAYOUT_universal(
    ...
    _______  , _______  , KC_1    , KC_2     , KC_3     ,S(KC_MINS), S(KC_8)  ,            S(KC_9)  , _______  , KC_LEFT  , KC_DOWN  , KC_RGHT  , KC_BTN8  , _______  ,
    _______  , _______  , KC_0    , KC_DOT   , _______  , _______  , _______  ,             KC_DEL  , _______  , _______  , _______  , _______  , KC_BTN6  , _______
  ),
